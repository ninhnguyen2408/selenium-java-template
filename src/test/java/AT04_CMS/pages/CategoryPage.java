...
public class CategoryPage {
      ...
      private By browseBanner = By.xpath("(//div[@class='input-group-prepend'])[1]/div");
      ...
      private By dialogDeleteConfirmation = By.xpath("// h4[normalize-space()='Delete Confirmation']");
