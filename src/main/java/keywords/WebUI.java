...
public class WebUI {
      ...
      public static void checkContainsValueOnTableByColumn(int column, String value) {
            ...
            if (totalRows.size() < 1) {
                  ...
                  for (int i = 1; i <= totalRows.size(); i++) {
                        ...
                        Assert.assertTrue(res, "Row " + i + " (" + title.getText() + ")"
                                    + "NOT contains the search value: " + value);
                  }
            }
      }
      ...
      public static void clickElement(By by, int seconds) {
            ...
            ExtentTestManager.logMessage(Status.INFO,
                        "Click on element " + by + " with timeout is " + seconds + " seconds ");
      }
      ...
      public static void sendKeys(By by, String text, int seconds) {
            ...
            ExtentTestManager.logMessage(Status.INFO,
                        "Set text " + text + " on input " + by + "with timeout is " + seconds + " seconds");
      }
      ...
      public static void setTextAndKeysENTER(By by, String text) {
            ...
            ExtentTestManager.logMessage(Status.INFO,
                        "Set text: " + text + " on element " + by + "sendKeys Keys.ENTER");
      }
